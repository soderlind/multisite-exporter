...
## [1.2.4] - 2025-05-14
### Fixed
- WP-CLI help command response for better usability
- Properly implemented class structure for WP-CLI commands

## [1.2.3] - 2025-05-14
### Fixed
- WP-CLI package installation and command execution issues
- Improved compatibility for `wp package install` by using anonymous functions
